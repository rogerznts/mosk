...
archived), and after the `migrate-install` task.
...
- Follow `.claude/mosk/data/phase-transition-contract.md` when advancing a
  spec; never edit `spec-meta.yaml.current_phase` directly.
