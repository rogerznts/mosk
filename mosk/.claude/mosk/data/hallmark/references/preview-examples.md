...
Four sample Step 5 preview blocks for the model to imitate, varied across macrostructure types. Load this file only when picking an unusual macrostructure or custom theme and the bullet-list spec in `hallmark.md § 5. Preview` doesn't give enough scaffolding on its own. Most builds don't need to read this file.
