...
- Jogadas legais do grafo: `.claude/mosk/scripts/legal_moves.sh`
- Atuador (fachada): `.claude/mosk/scripts/panes.sh` → `.claude/mosk/scripts/orca.sh`
- Transporte de contexto: skill `/mosk-handoff`
- Resolver paths/fase: `.claude/mosk/scripts/check-prerequisites.sh`, `read_spec_meta` em `.claude/mosk/scripts/common.sh`
