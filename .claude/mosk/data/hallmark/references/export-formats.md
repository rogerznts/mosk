...
Loaded by [`hallmark.md`](../hallmark.md) Step 6 when emitting the design system as portable tokens. Defines the four canonical formats Hallmark always writes:
...
When hallmark.md Step 6 emits exports:
