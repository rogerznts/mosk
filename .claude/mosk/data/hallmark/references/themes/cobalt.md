...
Loaded eagerly by hallmark.md Step 3 whenever the catalog pick is `cobalt`. The OKLCH palette + font stack live in [`tokens.css`](tokens.css) under `[data-theme="cobalt"]`. Canonical build: [`site/examples/cobalt-01/`](https://github.com/Nutlope/hallmark/tree/aeb42fb354ff4efa36ab475773a082315a3af2ce/site/examples/cobalt-01/) (an API product landing with a request/response hero).
